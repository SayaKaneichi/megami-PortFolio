...
import { NitroOptions, NitroRouteConfig, NitroConfig, Nitro, NitroEventHandler, NitroDevEventHandler, NitroRuntimeConfigApp, NitroRuntimeConfig } from 'nitropack';
...
interface NuxtModule<TOptions extends ModuleOptions = ModuleOptions, TOptionsDefaults extends Partial<TOptions> = Partial<TOptions>, TWith extends boolean = false> {
    ...
    onInstall?: (nuxt: Nuxt) => Awaitable<void>;
    onUpgrade?: (options: TWith extends true ? ResolvedModuleOptions<TOptions, TOptionsDefaults> : TOptions, nuxt: Nuxt, previousVersion: string) => Awaitable<void>;
}
